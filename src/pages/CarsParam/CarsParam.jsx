        ...
        data?.map((item, index) => (
          <div className="container" key={index}>
            <div className="imgContainer">
              <h1 className="subname">{item?.model?.name}</h1>
              <div className="row">
                <div className="col-lg-6">
                  <div className="sideImg">
                    {item.car_images && item?.car_images.map((img, index) => (
                      <img
                        key={index}
                        className="src1"
                  ...
                  >
                    {item?.car_images &&
                      item?.car_images?.map((swiper, index) => (
              ...
              <div className="row">
                <div className="carInfo">
                  <h3 className="heading-1">
                    Good to know about {item?.model?.name}
                  </h3>
                  <p className="p-1">Kilometrage limit per day</p>
                  <h4>{item?.max_speed} (Every extra km will be charged {item?.transmission} AED/km)</h4>
                  <p className="p-1">Car rental deposit amount</p>
                  <h4>The deposit is refunded within {item?.deposit} days</h4>
                </div>
              </div>
            </div>
            <div className="infoContainer">
              <div className="row_1">
                ...
                <div className="col-lg-4_1">
                  <h4>AED {item.price_in_aed_sale}</h4>
                  <h6 className="greyishText">
                    AED {item.price_in_aed_sale} for credit cards payment
                  </h6>
                  <h4>AED {item.premium_protection}</h4>
                  <h6 className="greyishText">
                    AED {item.premium_protection} price per day
                  </h6>
                </div>
              </div>
              <hr
              ...
              <div className="row_1">
                <div className="col-lg-6_2">
                  <a href="https://api.whatsapp.com/send/?phone=971558462124&text&type=phone_number&app_absent=0" className="whatsapp">
                    <svg
                      stroke="white"
                      fill="white"
                      strokeWidth="0"
                ...
                <div className="col-lg-6_2">
                  <a href="https://www.autozoomrental.com/carsinfo/tel:+971558462124" className="telephone">
                    <svg
                      stroke="white"
                      fill="white"
                      strokeWidth="1"
