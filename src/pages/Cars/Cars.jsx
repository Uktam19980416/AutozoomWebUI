    ...
    <div className='Cars_container_'>
        <div className='Cars_sidebar'>
            ...
            <div className="Cars_sidebar_offers_info">
              ...
              <label htmlFor="checkBox6">2 DAYS RENT = 5000 AED🔥 ALL INCLUSIVE</label>
            </div>
            <div className="Cars_sidebar_offers_info">
            ...
            <div className="Cars_sidebar_offers_info">
              ...
              <label htmlFor="checkBox8">4 DAYS RENT = 5000 AED🔥 ALL INCLUSIVE</label>
            </div>
            </div>
        ...
        <div className='Cars_container_main'>
          ...
          <a href="/" className='Cars_container_main_link'><span>Luxury Cars for Rent in Dubai </span> <span>/ Hire the latest supercar</span></a>
          </div>
